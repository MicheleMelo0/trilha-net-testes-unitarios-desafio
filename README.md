...
## Desafio de projeto
Para este desafio, foram utilizados os conhecimentos adquiridos no módulo de Testes Unitários com C#, da trilha .NET da DIO.
...
## Solução
Como solução do desafio, foram feitas as correções nos métodos de validação das classes *ValidacoesStringTests* e *ValidacoesListaTests* de forma que todos os testes realizados fossem aprovados. 